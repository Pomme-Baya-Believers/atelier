...
describe('AddToCart Component', () => {
  it('renders the AddToCart Component', () => {
    const addtocart = render(<AddToCart options={style}/>);
...
describe('AddToCartButton Component', () => {
  it('renders the AddToCartButton Component', () => {
    const addtocartbutton = render(<AddToCartButton sku={skus[0]} quantity={1} />);
    expect(addtocartbutton).toBeDefined();
  });
});

describe('BasicProductInfo Component', () => {
  it('renders the BasicProductInfo Component', () => {
    const basicproductinfo = render(<BasicProductInfo style={style}
      product={product} productID={40348} />);
    expect(basicproductinfo).toBeDefined();
  });
});
...
describe('ImageGalleryThumbnails Component', () => {
  ...
  it('renders the ImageGalleryThumbnails Component', () => {
    const imagegallerythumbnails = render(<ImageGalleryThumbnails handleThumbClick={handleThumbClick} photos={photos} mainPic={0}/>);
    expect(imagegallerythumbnails).toBeDefined();
  });
});

describe('Overview Component', () => {
  it('renders the Overview Component', () => {
    const overview = render(<Overview productID={40348}/>);
    expect(overview).toBeDefined();
  });
});

describe('ProductDescription Component', () => {
  it('renders the Product Description Component', () => {
    const productdescription = render(<ProductDescription product={product} />)
...
describe('SizeSelector Component', () => {
  it('renders the Size Selector Component', () => {
    const sizeselector = render(<SizeSelector skus={skus} handleSizeSelect={jest.fn()} />)
    expect(sizeselector).toBeDefined()
  });
});

describe('StyleSelector Component', () => {
  it('renders the Style Selecotr Component', () => {
